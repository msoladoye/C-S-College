...
function q11(){
    document.getElementById('questions').innerHTML = '\n\
        <section style="float: left; width: 40%;border: 1px solid black; height: 380px; font-size: 20px; padding: 10px 5px 5px 5px;">\n\
            <b>11)</b> Question one goes here</section>\n\
                            <section style="float: right; width: 58%;border: 1px solid black; height: 380px;">\n\
                                <section style="padding: 5%;">\n\
                                    <div class="option_row"><input type="radio" name="option" value="a" id="a" onclick="q11Ans(`a`)"/><p><b>[A]:</b> OPTION A</p></div>\n\
                                    <div class="option_row"><input type="radio" name="option" value="b" id="b" onclick="q11Ans(`b`)"/><p><b>[B]:</b> OPTION B</p></div>\n\
                                    <div class="option_row"><input type="radio" name="option" value="c" id="c" onclick="q11Ans(`c`)"/><p><b>[C]:</b> OPTION C</p></div>\n\
                                    <div class="option_row"><input type="radio" name="option" value="d" id="d" onclick="q11Ans(`d`)"/><p><b>[D]:</b> OPTION D</p></div>\n\
                                </section>\n\
                            </section>';
    if(selection[10] === 'a'){
